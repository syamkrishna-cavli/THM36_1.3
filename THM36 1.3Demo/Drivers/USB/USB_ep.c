...
#if	DYNAMICFIFO
__align(64) uint8_t g_abUsbEp0Buf[USB_BUF_LEN*2] __attribute__((at(USBFIFO_ADDR_START)));	//	USB Ep0 trans buf
#else 
__align(64) uint8_t g_abUsbBuf[MAXPKTSIZE*12] __attribute__((at(USBFIFO_ADDR_START)));
__align(64) uint8_t g_abUsbEp0Buf[USB_BUF_LEN*2];
#endif
