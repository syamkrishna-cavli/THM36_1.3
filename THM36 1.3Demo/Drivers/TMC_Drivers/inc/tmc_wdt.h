...
//#define IS_RCC_CLOCKSOURCE(SPURCE)					(((SPURCE) == RCC_ClockSource_HSE)   	|| \
//													 ((SPURCE) == RCC_ClockSource_HSI)   	|| \
//													 ((SPURCE) == RCC_ClockSource_LSE)   	|| \
//													 ((SPURCE) == RCC_ClockSource_LSI)		|| \
//													 ((SPURCE) == RCC_ClockSource_PLL))
