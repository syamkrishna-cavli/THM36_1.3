...
//TMC(20240408)-zt:为区分void FD3_IRQHandler(void)和void VB_SENSOR_IRQHandler(void)的入口参数，将VBAT_HandleTypeDef拆分为VBAT_HandleTypeDef和VBAT_FD3_HandleTypeDef
