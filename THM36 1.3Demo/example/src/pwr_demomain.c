...
//TMC(20240408)-zt:split EXTI_StateTypeDef EXTI_State to 8 variables
/*EXTI State*/
...
/**
  * @brief After waking up from stop mode, increase system clock step by step
...
void PWR_Stop_DemoMain(void)
{
	...
	PWR_Stop_Demo_IRQ_WakeUp(PWR_STOPEntry_WFI, IWDTwakeup);	//GPIOB_14 is low then enter Stop mode.
}
